...
class CompletedExamsPage extends StatelessWidget {
  ...
  Widget _buildSummaryBanner() {
    return Obx(() {
      ...
      final totalMark =
          ctrl.exams.fold<int>(0, (sum, e) => sum + e.mark);
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.quiz_outlined,
                color: _green2, size: 48),
          ),
          const SizedBox(height: 20),
          const Text('No completed exams yet',
              style: TextStyle(
                  color: _textDark,
                  fontSize: 17,
                  fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
          const Text('Take an exam and your results will appear here.',
